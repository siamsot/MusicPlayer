    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        album1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent openAlb1 = new Intent(Library.this, NowPlaying.class);
        ...
        album2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent openAlb2 = new Intent(Library.this, NowPlaying.class);
                        startActivity(openAlb2);
                    }});
        album3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent openAlb3 = new Intent(Library.this, NowPlaying.class);
                startActivity(openAlb3);
            }});
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(Library.this, MainActivity.class);
                startActivity(back);
            }});
            }
    }
